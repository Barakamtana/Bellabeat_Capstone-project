...
```{r}
# See head and tail
head(hourlyIntensities_merged_df, 30)
...
```{r}
hourlyCalories_merged_df[is.element(hourlyCalories_merged_df$ActivityHour,
                                    c(1457773200)),]
```
...
hourlyCalories_merged_df[df$state %in% c('1457773200','1457773200','1457773200'),]
